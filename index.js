...
const settings = {
  name: "blast Api's",
  description: "blast Api is a simple and lightweight REST API built with Next.js, designed to provide easy access to various web functionalities.", 
  apiSettings: {
    creator: "wilzzofficial",
    apikey: ["wilzz1213"]
  },
    linkWhatsapp: "https://t.me/ch_wilzzbot",
    linkYoutube: "https://t.me/csdigitalpedia"
};
...
app.use((req, res, next) => {
  ...
  res.json = function (data) {
    if (data && typeof data === 'object') {
      const responseData = {
        status: data.status,
        creator: settings.apiSettings.creator || "Created Using xDonzCode",
        ...data
      };
